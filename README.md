...
| モジュール | 機能 |
|---|---|
| LP生成エンジン | 商品情報からHTML LPを自動生成。LINE友達追加ボタンを自動埋め込み |
| LINE登録トラッカー | どのLPから・いつ登録したかをユーザーIDと紐付けて記録 |
| 自動フォロー配信 | 登録直後〜7日間の自動ステップ配信で信頼構築→購買誘導 |
| クロージング分析 | 返信の感情分析・成約確率表示・反論処理3パターン自動生成 |
| 離脱検知 | 個人レベルの冷め度スコアリング・閾値超えで売り手に即アラート |

## 技術スタック

- **バックエンド**: Node.js / Express
- **DB**: Supabase (PostgreSQL)
- **分析エンジン**: Claude API (Anthropic)
